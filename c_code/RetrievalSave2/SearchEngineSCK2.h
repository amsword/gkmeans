...
class SearchEngineSCKMeans2 : public ::SearchEngine
{
public:
	void ANNSearching(void* p_query, int* vec_nn_idx);

public:
	void Initialize(const SMatrix<CodeType>* p_data_base, 

...
void SearchEngineSCKMeans3::PopFromHeap(Heap<PAIR<double> >& heap, int* p_idx)
{
	int k = heap.size() - 1;
...
//void SearchEngineSCKMeans3::ConstructInnerProductMatrix(int idx_table)
//{
//
...
//double SearchEngineSCKMeans3::ConstructPreComputedEachPoint(int idx_point)
//{
//	double s = 0;
//
//	short* p_point = m_pmatDataBase->operator[](idx_point);
//
...
//void SearchEngineSCKMeans3::ConstructPreComputedEachPoint()
//{
...
//void SearchEngineSCKMeans3::ConstructInnerProductMatrix()
//{
...
void SearchEngineSCKMeans3::Initialize(const SMatrix<short>* p_data_base, 
...
void SearchEngineSCKMeans3::ANNSearching(
...
double SearchEngineSCKMeans3::ASymmetricDistance(
...
void SearchEngineSCKMeans3::ConstructQueryCodewordInnerProduct(
		double* p_query, SMatrix<double> &matQueryCodewordInnerProduct)
{
	...
	for (int k = 0; k < m_numTables; k++)
	{
		...
		for (int i = 0; i < m_nNumCodeWordEach; i++)
		{
			...
			p[i] = squared_distance(p_query, matCodebook[i], m_nSubDimensionsEach);
		}
...
void SearchEngineSCKMeans3::FindBestCandidateAsy(double* p_query, Heap<PAIR<double> >& heap_knn)
{
